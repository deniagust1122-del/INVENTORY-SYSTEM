    ...
    <div className="min-h-screen bg-slate-50 p-6 md:p-12 print:bg-white print:p-0">
      ...
      >
        ...
        <div className="flex justify-between items-start border-b-2 border-slate-900 pb-6 mb-6">
          <div>
            <h1 className="text-xl font-bold text-slate-900 uppercase tracking-wide">PT. KI</h1>
        ...
        <div className="border-t border-dashed border-slate-300 mt-8 pt-4 text-center text-[10px] text-slate-400 font-mono">
          PT. KI Inventory Management System • Dokumen ini dihasilkan secara otomatis pada tanggal {new Date().toLocaleString('id-ID', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit', second: '2-digit', timeZoneName: 'short' })}
        </div>
      </div>
    </div>
  );
